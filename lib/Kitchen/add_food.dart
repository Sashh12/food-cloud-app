...
class _AddFoodState extends State<AddFood> {
  ...
  TextEditingController optionalingredientcontroller = TextEditingController();
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    color: Color(0xFFececf8), borderRadius: BorderRadius.circular(10)),
                child: TextField(
                  controller: optionalingredientcontroller,
                  decoration: InputDecoration(
                    border: InputBorder.none,
                    hintText: "Enter Optional Ingredients (comma-separated)",
                    hintStyle: TextStyle(fontSize: 16),
                  ),
                ),
              ),
